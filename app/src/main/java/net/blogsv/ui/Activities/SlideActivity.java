...
import net.blogsv.Adapters.SlideAdapter;
import net.blogsv.Provider.PrefManager;
import net.blogsv.ntsmxh.R;
import net.blogsv.ui.view.CarouselEffectTransformer;
import net.blogsv.ui.view.ClickableViewPager;
...
public class SlideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slide_adapter = new SlideAdapter(getApplicationContext(), slideList);
