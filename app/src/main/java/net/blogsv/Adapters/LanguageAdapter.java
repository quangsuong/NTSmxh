...
public class LanguageAdapter extends RecyclerView.Adapter implements SelectableViewHolder.OnItemSelectedListener {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        Picasso.get().load(selectableItem.getImage()).error(R.drawable.flag_placeholder).placeholder(R.drawable.flag_placeholder).into(holder.image_view_iten_language);
